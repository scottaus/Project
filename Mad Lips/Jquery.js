...
function showInfo(){
    ...
    $("#output3").text(message3).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output4").text(message4).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output5").text(message5).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output6").text(message6).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output7").text(message7).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output8").text(message8).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output9").text(message9).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output10").text(message10).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output11").text(message11).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output12").text(message12).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output13").text(message13).show().animate({"left":"0px","opacity":"1"}, "slow")
    $("#output14").text(message14).show().animate({"left":"0px","opacity":"1"}, "slow")
}